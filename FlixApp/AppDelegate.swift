...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        nowPlayingNavigationController.tabBarItem.image = UIImage(named: "1466192267_resultset_next")
        ...
        topRatedNavigationController.tabBarItem.image = UIImage(named: "1466192220_Favourites")
